  -- final_exam_responses -> DS_Sample_Final.csv

  CREATE OR REPLACE FUNCTION public.update_sample_final_from_response()
  RETURNS trigger
  LANGUAGE plpgsql
  SECURITY DEFINER
  ...
  AS $$
  BEGIN
    UPDATE public."DS_Sample_Final.csv"
    SET
  ...
  UPDATE public."DS_Sample_Final.csv" d
  SET
